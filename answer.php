                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <div class="form-group">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et commodi laboriosam quasi odit expedita voluptates eum assumenda, iusto pariatur ducimus aliquid itaque quibusdam obcaecati architecto laudantium sunt! In, dolore consequuntur.</p>
                      </div>
                      <div class="form-group">
                        <label for="category">Answer</label>
                        <textarea rows="10" cols="30" class="form-control" id="category" placeholder="Answer" name="answer"></textarea>
                      </div>
                      <br>
