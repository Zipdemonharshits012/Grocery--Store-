        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <thead class="bg-light">
                          <tr>
                            <th>Customer Name</th>
                            <td><p class="mb-0 font-weight-medium">Cecelia Cooper</p></td>
                          </tr>
                          <tr>
                            <th>Address</th>
                            <td style="word-break:break-all;">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Harum veniam sapiente nam iusto at.</td>
                          </tr>
                          <tr>
                            <th>Phone No</th>
                            <td>9876543210</td>
            ...
            <div class="page-header flex-wrap">
              ...
              <div class="d-flex">
                <a href="index.php" style="color:#ffffff;"><button type="button" class="btn btn-sm ml-3 btn-success"> Complete </button></a>
              </div>
            </div>
