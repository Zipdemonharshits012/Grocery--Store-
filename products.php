        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            ...
            <div class="page-header flex-wrap">
              ...
              <div class="d-flex">
                <a href="add-product.php" style="color:#ffffff;"><button type="button" class="btn btn-sm ml-3 btn-success"> Add Product </button></a>
              </div>
            </div>
                        ...
                        <tbody>
                          <!-- Table row -->
                            <tr>
                              ...
                              <td>Rs 200</td>
                              <td>
                                <a href="add-product.php"><div class="badge badge-inverse-danger" style="font-size: small ;"> Edit </div></a>
                              </td>
                            </tr>
                          <!-- /Table row -->
                        </tbody>
